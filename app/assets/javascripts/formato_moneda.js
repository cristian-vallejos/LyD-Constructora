...
function revertirMoneda() {
  ...
  console.log("Solicitado: "+array_solicitado);
  ...
  console.log("Aprobado: "+array_aprobado);
  ...
  console.log("Renta líquida: "+array_renta_liquida);
  ...
  console.log("Finiquito: "+array_finiquito);
  ...
  console.log("Descuentos: "+array_descuentos_en_curso);
}
